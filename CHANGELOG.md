...
### Fixed
- Git operations now work correctly when projects are in different git repositories
- Each repo gets its own commit instead of failing with "outside repository" error
